...
public class LoggedTunableValue {
  ...
  public LoggedTunableValue(String dashboardKey) {
    ...
    initDefault( m_constants.getProperty(yamlKey));
  }
  ...
  public void periodic() {
    if(defaultValue instanceof Double){
      m_constants.setProperty(yamlKey, getDouble());
    }
    if(defaultValue instanceof Integer){
      m_constants.setProperty(yamlKey, getInteger());
    }
    if(defaultValue instanceof Boolean){
      m_constants.setProperty(yamlKey, getBool());
    }
    if(defaultValue instanceof String){
      m_constants.setProperty(yamlKey, getString());
    }
